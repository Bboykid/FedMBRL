...
class PendulumEnvEmb(gym.Env):
    ...
    * v0: Initial versions release
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0):
        ...
        high = np.array([1.0, 1.0, self.max_speed, self.EMB_MAX], dtype=np.float32)
    ...
    def step(self, u):
        ...
        return np.concatenate((self._get_obs(),self.emb)).astype(np.float32), -costs, False, False, {}
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        if self.render_mode == "human":
            self.render()
        return np.concatenate((self._get_obs(),self.emb)).astype(np.float32), {}
